...
<br/> <br/>
Nightmare is a platformer prototype which intends to mimic the experience of flying in a dream.
...
## Basic actions
Using the left stick (on gamepad) or the WASD keys, the player can freely **run** at different speeds. Depending on how far the input is being pressed.
<br/> <br/>
